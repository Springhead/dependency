...
// --> [2013/04/24]
//	Function declarations need to have "__cdecl" calling convention.
#if defined _MSC_VER
...
// --> [2013/04/24]
//	Function definitions must not have calling convention token.
#undef	__CDECL
#define	__CDECL
#undef	BOOST_NUMERIC_BINDINGS_LAPACK_DETAIL_LAPACK_NAMES_H
#include <boost/numeric/bindings/lapack/detail/lapack_names.h>
// <-- [2013/04/24]
