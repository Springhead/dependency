...
#define FORTRAN_ID( id ) __CDECL id##_
#define FORTRAN_ID2( id, ID2 ) __CDECL id##_
#elif defined(BIND_FORTRAN_LOWERCASE)
#define FORTRAN_ID( id ) __CDECL id
#define FORTRAN_ID2( id, ID2 ) __cdecl id
#elif defined(BIND_FORTRAN_UPPERCASE_UNDERSCORE)
#define FORTRAN_ID2( id, ID2 ) __CDECL ID2##_
#elif defined(BIND_FORTRAN_UPPERCASE)
#define FORTRAN_ID2( id, ID2 ) __CDECL ID2
#else
