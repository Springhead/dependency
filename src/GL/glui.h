...
typedef void (GLUTCALLBACK *Int4_CB)        (int, int, int, int);
...
public:
    ...
    **********/
    ...
    void set_glutOverlayDisplayFunc(void(GLUTCALLBACK *f)(void)){glutOverlayDisplayFunc(f);}
...
*/
#ifdef BUILD_GLUI_DLL
 extern GLUI_Master_Object __declspec(dllexport) GLUI_Master;
#else
#ifdef _MSC_VER
 extern GLUI_Master_Object __declspec(dllimport) GLUI_Master;
#else
